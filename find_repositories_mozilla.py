...
mozilla_path = './LOG6307E/replication/mozilla_repos.txt'
...
for repo in mozilla_repositories:
    ...
    temp_zip = "./LOG6307E/replication/repositories/Mozilla/tip.zip"
    # Folder for saving
    extracted_dir = "./LOG6307E/replication/repositories/Mozilla/"
